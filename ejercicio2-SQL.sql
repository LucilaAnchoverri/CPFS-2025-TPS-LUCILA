...
SELECT * FROM E01_PRODUCTO ORDER BY nombre; 
...
SELECT * FROM E01_TELEFONO WHERE codigo_area <> 844 AND (numero > 4369984 OR tipo = 'F');
...
SELECT * FROM E01_TELEFONO WHERE tipo <> 'F' AND numero <= 4892549;